    ...
    <div className="min-h-screen flex">
      ...
      <Image
        ...
        <div className="bg-white bg-opacity-90 p-10 rounded-xl shadow-lg">
          <h2 className="text-4xl font-bold mb-6 text-center text- bg-gradient-to-r from-magenta to-fuchsia text-transparent bg-clip-text animate-fade-in">Welcome!!</h2>
          <p className="text-center mb-8 text- bg-gradient-to-r from-magenta to-fuchsia text-transparent bg-clip-text animate-fade-in">Login. Ask. Get Answer</p>
